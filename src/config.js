...
export const PATCH_NOTES = [
    { version: 'Alpha 0.9.76.153', notes: ['Introduced Satellite Augmentation System: spawn budget now dynamically scales with the number of deployed satellites. Each satellite adds +15% to the wave threat budget, preventing well-fortified runs from becoming trivial.', 'Added an in-game notice at wave start showing the active augment multiplier when 3+ satellites are deployed.', 'Wave HUD now displays the current satellite augment multiplier alongside the round total.'] },
